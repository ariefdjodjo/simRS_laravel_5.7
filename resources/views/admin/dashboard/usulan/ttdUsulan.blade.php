	...
	<div class="modal modal-default fade" id="setDefault">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="box-body">
              <form  role="form" method="POST" action="{{ url('ttdUsulan/setDefault') }}">
                @csrf
                  ...
                  <table class="" width="100%">
                    <tr>
                      <td width="30%"><b>Nama Kepala</b></td>
                      <td width="70%">
                    	   <select id="id_ttd_usulan" class="form-control" name="id_ttd_usulan" style="width:100%">
                              <option value="">-- Pilih Penandatangan --</option>
                              @foreach($data as $list) 
                                  <option value="{{ $list->id_ttd_usulan}}">{{ $list->nama_kepala }} - {{ $list->jabatan }}</option>
                              @endforeach
                          </select>
                          <small class="help-block"></small>
                          <script>
                               $('#id_ttd_usulan').selectize({
                                create: false,
                                sortField: 'text'
                               });
                          </script>
                ...
                <div class="box-body">
                	<table id="dataTtd" class="table table-bordered">
                		...
                		<tbody>
                          ...
                          <!-- Modal Edit -->
                        <div class="modal modal-default fade" id="edit{{$ttd->id_ttd_usulan}}">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <div class="modal-body">
                                  <div class="box-body">
                                    <form  role="form" method="POST" action="{{ url('ttdUsulan/edit/'.$ttd->id_ttd_usulan.'') }}">
                                      @csrf
                                        ...
                                        <table class="" width="100%">
                                          <tr>
                                            <td width="30%"><b>Nama Kepala</b></td>
                                            <td width="70%">
                                              <input id="nama_kepala" type="text" class="form-control {{ $errors->has('nama_kepala') ? ' is-invalid' : '' }}" name="nama_kepala" value="{{ $ttd->nama_kepala }}" placeholder="Nama Kepala" required autofocus style="width:100%">
                                              <input type="hidden" name="id_unit_kerja" value="{{Auth::user()->id_unit_kerja}}">
                                              <input type="hidden" name="id_unit_kerja" value="{{$ttd->id_ttd_usulan}}">
                                              <small class="help-block"></small>
                                              @if ($errors->has('nama_kepala'))
                                                  <span class="invalid-feedback" role="alert">
                                                      <strong>{{ $errors->first('nama_kepala') }}</strong>
                                          ...
                                          <tr>
                                            <td><b>NIP</b></td>
                                            <td>
                                              <input id="nip_kepala" type="text" class="form-control {{ $errors->has('nip_kepala') ? ' is-invalid' : '' }}" name="nip_kepala" value="{{ $ttd->nip_kepala }}" required autofocus placeholder="NIP Kepala" style="width:100%">
                                              <small class="help-block"></small>
                                              @if ($errors->has('nip_kepala'))
                                                  <span class="invalid-feedback" role="alert">
                                                      <strong>{{ $errors->first('nip_kepala') }}</strong>
                          ...
                          -->
                            ...
                            <!-- modal untuk hapus -->
                            <div class="modal modal-warning fade" id="hapus{{$ttd->id_ttd_usulan}}">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  ...
                                  <div class="modal-body" style="color:#ffffff;">
                                    <form method="POST" action="{{ url('/ttdUsulan/hapus/'.$ttd->id_ttd_usulan.'') }}">
                                      @csrf
                                      <input type="hidden" name="id" id="id" value="{{ $ttd->id_ttd_usulan }}">
