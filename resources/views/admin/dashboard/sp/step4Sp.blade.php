        ...
        <div class="box box-primary">
                ...
                <div class="bg-info row" style="padding:5px; margin: 5px;">
                    ...
                    <div class="pull-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#kirim"><i class="fa fa-paper-plane"></i> Kirim</button>
                    </div>  
                </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($sp->status_sp == 1)
                                                        <small class="label bg-success">Aktif</small>
                                                    @else
                                                        <small class="label bg-danger">Batal</small>
                                                    @endif
                                                </td>
        ...
        <div class="bg-orange color-palette" style="padding:2px 15px 2px 15px">
            <ul class="pager">
                <li class="previous success">
                    <a href="{{url('spp/tambah/step3/'.$tahun.'/'.$id)}}">&larr; KEMBALI STEP 3</a>
                </li>
                @if($sp->tgl_kirim_sp != NULL)
                <li class="next">
                    <a href="{{url('spp/tambah/step5/'.$tahun.'/'.$id)}}"><i class="icon icon-ok"></i> Selesai &rarr;</a>
                </li>
                @endif
            </ul>
        </div>
    ...
    <div class="modal fade" id="kirim">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Kirim Dokumen</h4>
            </div>
            <div class="modal-body">
                <form action="{{url('spp/kirimSp/'.$tahun.'/'.$id)}}" method="POST" onsubmit="return validasi()">
                    @csrf
                    <div class="form-group">
                        <label class="col-md-4 control-label text-md-right" for="halsp">Nomor SP</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="no_sp" id="no_sp" value="{{$sp->no_sp}}">
